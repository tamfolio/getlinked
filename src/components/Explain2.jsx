...
function Explain2({img, title, spanned, para }) {

  return (
    <div className={`w-[100%] h-auto flex flex-col md:flex-row-reverse items-center justify-center md:justify-between bg-blue gap-[58px] px-[42px] pt-[29px] pb-[50px] lg:pl-[256px] lg:pr-[169px] lg:gap-[109px]`}>
